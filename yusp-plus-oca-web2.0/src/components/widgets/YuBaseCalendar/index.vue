          ...
          >
            ...
            <div class="button-group" style="text-align: center">
              ...
              <el-button
                type="primary"
                @click="deleteFn"
                v-if="viewType == 'UPDATE'">删除</el-button>
...
import "static/fullcalendar/fullcalendar.min.css"
import { clone, dateFormat } from '@/utils'

export default {
  name: "YuBaseCalendar",
  componentName: "YuBaseCalendar",
  props: {
  ...
  methods: {
    ...
    saveInfo: function () {
      ...
      if (
        ...
        !this.$refs.refForm.formdata.allDay[0]
      ) {
        this.$message({
      ...
      if (this.$refs.refForm.formdata.allDay[0] === 1) {
