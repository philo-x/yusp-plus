 ...
 */
EditorUi = function(editor, container, lightbox, ops)
{
  ...
  this.ops = ops;
	// if(this.ops.format === false) {
  //   this.formatWidth = 0;
  // }
  if(this.ops.sidebarFooter === false) {
    this.sidebarFooterHeight = 0;
    this.footerHeight = 0;
  }
  if(this.ops.toolbar === false) {
    this.toolbarHeight = 0;
  }
  if(this.ops.sidebar === false) {
    this.hsplitPosition = 0;
  }
  if(this.ops.menuBar === false) {
 ...
 */
EditorUi.prototype.splitSize = 0; // (mxClient.IS_TOUCH || mxClient.IS_POINTER) ? 12 : 8;
 ...
 * screen widths <= 640px.
 */
EditorUi.prototype.hsplitPosition = 72;
...
EditorUi.prototype.refresh = function(sizeDidChange)
{
	...
	if (this.menubar != null) {
		...
		tmp += this.ops.menuBar !== false ? this.menubarHeight : 0;
	}
	
	if (this.toolbar != null) {
		this.toolbarContainer.style.top = this.ops.menuBar !== false ? (this.menubarHeight + 'px') : '0';
...
EditorUi.prototype.createDivs = function()
{
	...
	this.toolbarContainer = typeof this.ops.toolbar === 'string' ? document.getElementById(this.ops.toolbar) : this.createDiv('geToolbarContainer');
	this.sidebarContainer = typeof this.ops.sidebar === 'string' ? document.getElementById(this.ops.sidebar) : this.createDiv('geSidebarContainer');
	this.formatContainer = typeof this.ops.formatbar === 'string' ? document.getElementById(this.ops.formatbar) : this.createDiv('geSidebarContainer geFormatContainer');
...
EditorUi.prototype.createUi = function()
{
	...
	// Creates the sidebar
	this.sidebar = (this.editor.chromeless) ? null : this.createSidebar(this.sidebarContainer, this.ops.sidebar);
  ...
  if(typeof this.ops.toolbar !== 'string'){
    // Creates toolbar
 ...
 */
EditorUi.prototype.createSidebar = function(container, ops)
{
	return new Sidebar(this, container, ops);
};
