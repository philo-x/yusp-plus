...
Actions.prototype.init = function()
{
	...
	this.addAction('saveData', function(evt) { graph.saveData();}, null, null, Editor.ctrlKey + '+S').isEnabled = isGraphEnabled;
  ...
  // custom
	this.addAction('relayout', function() { graph.relayout(); });
