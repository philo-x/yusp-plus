 ...
 */
@Component("adminSmLogClearTask")
public class AdminSmLogClearTask implements ITask {

    private static final Logger log = LoggerFactory.getLogger(AdminSmLogClearTask.class);
    ...
    public void run(String params) {
        ...
        adminSmLogService.clearAdminSmLog(day);
    }
}
