...
import cn.com.yusys.yusp.commons.req.crypto.nonce.RequestNonceCheck;
 ...
 */
@Service
public class CrmRequestNonceCheck implements RequestNonceCheck {
    ...
    public boolean check(HttpServletRequest httpServletRequest) {
        ...
        Set<String> urls = contrService.getRequestCheckList(Constant.REQUEST_NONCE);
